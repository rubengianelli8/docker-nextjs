...
exports.Prisma.Str_userScalarFieldEnum = makeEnum({
  id: 'id',
  username: 'username',
  password: 'password',
...
exports.Prisma.Str_roleScalarFieldEnum = makeEnum({
  id: 'id',
  name: 'name',
  description: 'description'
});

exports.Prisma.Str_permissionScalarFieldEnum = makeEnum({
  id: 'id',
  name: 'name',
  description: 'description'
});

exports.Prisma.Str_role_x_userScalarFieldEnum = makeEnum({
  id: 'id',
  id_role: 'id_role',
  id_user: 'id_user',
...
exports.Prisma.Str_permission_x_roleScalarFieldEnum = makeEnum({
  id: 'id',
  id_role: 'id_role',
